...
console.log(Math.min.apply(this, ages))

console.log(Math.max.apply(Math, ages))
console.log(Math.max.apply(this, ages))


console.log(Reflect.apply(Math.min, Math, ages))
console.log(Reflect.apply(Math.min, this, ages))

console.log(Reflect.apply(Math.max, Math, ages))
console.log(Reflect.apply(Math.max, this, ages))
