...
var g = f();
console.log(console.log(g.next()))
console.log(console.log(g.next()))
...
面代码先定义了一个可以无限运行的 Generator 函数f，如果next方法没有参数，每次运行到yield表达式，变量reset的值总是undefined。
...
console.log(g.return(7)) // { value: 6, done: false }
...
const inner_obj = gen.next().value
console.log(inner_obj)
for (let value of inner_obj) {
